      ...
      <View className='bg-white h-full w-full'>
        ...
        <View className="h-full w-full flex justify-around pt-48">
          ...
          <View className="flex items-center mx-4 space-y-4">
            ...
            <Animated.View entering={FadeInDown.delay(200).duration(1000).springify()} className="bg-black/10 p-2 rounded-2xl w-full ">
              <TextInput placeholder='Email' placeholderTextColor={'gray'} />
            </Animated.View>
            <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} className="bg-black/10 p-2 rounded-2xl w-full mb-3" >
